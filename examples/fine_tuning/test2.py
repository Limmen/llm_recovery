...
if __name__ == '__main__':
    ...
    prompt = "<observation>940</observation><action>Reconfigure firewall to block port 80 on target host IPs=15.9.7.17 OS=Ubuntu 20 Services/Ports=SSH:22/SNMP:161/SMTP:25/Postgres:5432/NTP:123</action><rtg>-403.0</rtg> <observation>2231</observation>"
    lr = 5e-5
    # lr = 5e-4
